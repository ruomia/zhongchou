                        ...
                        <div class="defaultTab-T">
                            <table border="0" cellspacing="0" cellpadding="0" class="defaultTable">
                                <tbody><tr>
                                    ...
                                    <th class="t_3">发布时间
                                        @if($req->od=='asc')
                                            <a href="{{  route('crowd.shenhe',  array_merge(  $req->all() ,  ['od'=>'desc']    )  )  }}" > ⬇⬇ </a>
                                        @else
                                            <a href="{{  route('crowd.shenhe',  array_merge(  $req->all() ,  ['od'=>'asc']      )  )  }}" > ⬆⬆ </a>
                                        @endif
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td class="t_4">
                                        <div class="btn">
                                            ...
                                            @endif
                                            <a href="{{route('crowd',['id'=>$v->id])}}" class="modify">查看</a>
                                            {{--<a href="" class="modify">置顶</a>--}}
                                            <a onclick="return confirm('确定要删除吗？');" href="{{ route('shenhe.delete' , ['id' => $v->id]) }}" class="delete">删除</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
